...
public class Person {
     ...
     * initializes the name and first name properties 
     * of the instance to an empty string
     */
    public Person() {
        this.lastName = "";
        this.firstName = "";
    ...
    public String getLogin() throws IllegalStateException {
        ...
        String p = "";
        if (!"".equals(firstName)) {
            p = Normalizer.normalize(firstName.substring(0, 1), Normalizer.Form.NFD);
            p = p.replaceAll("[^\\p{ASCII}]", "");
        }
        if (!"".equals(lastName)) {
            n = Normalizer.normalize(lastName, Normalizer.Form.NFD);
    ...
    /**
     * Method returning the person's last name
    ...
    /**
     * Method defining the person's last name
     * @param lastName the person's last name
     */
    public void setLastName(String lastName) {
        this.lastName = cleanUpString(lastName.toUpperCase());
    }

    /**
     * Method returning the person's first name
    ...
    /**
     * The setter of the person's first name 
     * @param fName the first name to set
     */
    public void setFirstName(String fName) {
        this.firstName = toPascalCase(fName);
    }
    
    /**
     * Method returning the person's email
    ...
    /**
     * Method returning the person's date of birth
    ...
    /**
     * Method definding the person's date of birth 
    ...
    /**
     * Method defining the person's favorite color
     * @param fC the color to set
     */
    public void setFavColor(String fC) {
        this.favColor = fC;
    }
    ...
    // *******************************
    /**
     * Method cleaning the input string of superfluous dashes at its begin and end
     * @param str the string to clean of dashes
     * @return the string cleaned of dashes
     */
    protected String trimWithDash(String str) {
        // Method greatly inspired by the trim method of the String class
        int len = str.length();
        int st = 0;
    ...
    /**
     * Method cleaning the input string of spaces and dashes at its begining and end
